...
public interface IProjectDetailService {
	...
	/**
	 * @getProjectDetailById:根据主键 查询
	 * @param queryCondition 查询条件
	 * @return QueryResultObject 查询结果
	 * @date 2020-06-05 11:23:22
	 * @author ru3an
	 */
	public QueryResultObject getProjectDetailById(String id);
	/**
	 * @remove:根据idObject删除
	 * @param idObject 主键id
	 * @return void
	 ...
	 * @author ru3an
	 */
	public ProjectDetail saveProjectDetail(Map<String,Object> map) throws Exception;
	/**
	 * @query:根据查询条件 查询
	 * @param queryCondition 查询条件
	 * @return QueryResultObject 查询结果
